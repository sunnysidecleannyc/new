...
export function homepageContent() {
  return {
    ...
    metaDescription: 'NYC\'s top-rated cleaning service from $59/hr. House cleaning across Manhattan, Brooklyn & Queens. Licensed, insured. 5.0★ Google. (212) 202-9030',
...
export function areaContent(area: Area) {
  ...
  return {
    ...
    metaDescription: `Professional cleaning in ${area.name} from $59/hr. Deep cleaning, weekly service, move-in/out & more. 5.0★ Google. (212) 202-9030`,
...
export function neighborhoodContent(neighborhood: Neighborhood, area: Area) {
  ...
  return {
    title: `${h1} | ${area.name}`,
    metaDescription: `Professional cleaning in ${neighborhood.name}, ${area.name} from $59/hr. Serving ${neighborhood.housing_types.slice(0, 2).join(', ')} near ${neighborhood.landmarks[0]}. 5.0★ Google. (212) 202-9030`,
    h1,
    intro,
  }
}
...
export function neighborhoodServiceContent(neighborhood: Neighborhood, service: Service, area: Area) {
  ...
  return {
    title: `${h1} | ${area.name}`,
    metaDescription: `${service.name} in ${neighborhood.name}, ${area.name}. ${service.features.slice(0, 2).join(', ')} & more. ${service.priceRange}. 5.0★ Google. (212) 202-9030`,
    h1,
    intro,
    whyUs: [
...
export function serviceContent(service: Service) {
  return {
    ...
    metaDescription: `Professional ${service.name.toLowerCase()} across Manhattan, Brooklyn & Queens. ${service.features.slice(0, 2).join(', ')} & more. ${service.priceRange}. 5.0★ Google. (212) 202-9030`,
...
const richContentMap: Record<string, ServiceRichContent> = {
  'deep-cleaning': {
    ...
    educationSections: [
      ...
      },
      {
        ...
        body: [
          'We charge by the hour — $59/hr with your supplies, $79/hr when we bring everything. The total cost depends on how long the job takes.',
    ...
    pricingNote: 'Most deep cleans cost between $196 and $390 total. A studio typically runs $196–$245 (4–5 hrs at $59/hr), while a 3-bedroom averages $320–$390 (5–6 hrs at $79/hr). Your first deep clean is always the most expensive — after that, recurring service at $59/hr keeps costs low.',
    faqs: [
      ...
      { question: 'How much does a deep cleaning cost in NYC?', answer: 'Deep cleaning costs $59–$79/hr depending on who provides supplies. A typical studio deep clean runs $196–$260 (4–5 hours). A 2-bedroom is usually $260–$390 (4–6 hours). A 3-bedroom can be $325–$520 (5–8 hours). We charge by the hour so you only pay for the time your space actually needs.' },
      ...
      { question: 'What products do you use for deep cleaning?', answer: 'At $79/hr we bring professional-grade degreasers, bathroom cleaners, glass cleaner, microfiber systems, and a commercial vacuum. At $59/hr you provide your own products. We\'re happy to use eco-friendly or hypoallergenic products — just let us know.' },
  ...
  'regular-cleaning': {
    ...
    nycTips: [
      ...
      { title: 'Provide your own supplies to save ~21%', detail: 'At $59/hr vs $79/hr, providing your own vacuum, mop, and basic cleaning products saves you $32+ per 2-hour visit. Over a year of weekly cleanings, that\'s $1,600+ in savings.' },
    ...
    educationSections: [
      ...
      },
      {
        ...
        body: [
          'Regular cleaning starts at $59/hr when you provide supplies or $79/hr when we bring everything. A typical 2-hour regular clean for a 1-bedroom costs just $98 with your supplies.',
    ...
    faqs: [
      ...
      { question: 'How much does regular apartment cleaning cost in NYC?', answer: 'Regular cleaning is $59/hr with your supplies or $79/hr when we bring everything. A typical 1-bedroom takes 2 hours ($98–$130). A 2-bedroom takes 2.5–3 hours ($122–$195). Weekly clients see the lowest per-visit costs.' },
  ...
  'bi-weekly-cleaning': {
    ...
    faqs: [
      { question: 'How much does bi-weekly cleaning cost in NYC?', answer: 'Bi-weekly cleaning is $59/hr with your supplies or $79/hr when we bring everything. A 1-bedroom typically costs $122–$162 per visit (2.5 hours). A 2-bedroom runs $147–$195 (3 hours). You pay for time worked — no flat-rate markups.' },
  ...
  'monthly-cleaning': {
    ...
    faqs: [
      { question: 'How much does monthly cleaning cost in NYC?', answer: 'Monthly cleaning is $59/hr with your supplies or $79/hr when we bring everything. A 1-bedroom typically costs $147–$195 (3–4 hours). A 2-bedroom runs $171–$260 (3.5–5 hours). Monthly cleans take longer than weekly because there\'s more buildup to address.' },
  ...
  'same-day-cleaning': {
    ...
    whatIs: {
      ...
      body: [
        ...
        'Same-day cleanings cover the same scope as our regular cleaning service — full kitchen, bathrooms, surfaces, floors, and more. The difference is priority scheduling and the $99/hr rate that compensates our cleaner for rearranging their day.',
    ...
    nycTips: [
      { title: 'Text us early for best availability', detail: 'Same-day requests sent before 10am have the best chance of afternoon availability. After noon, same-day availability drops significantly. Text (212) 202-9030 as early as possible for the best shot at a same-day slot.' },
      ...
      { title: 'Same-day is a premium service — plan ahead when possible', detail: 'At $99/hr, same-day service costs roughly double our regular rate. If you know you\'ll need cleaning this week, booking 2–3 days ahead at $59–$79/hr saves significant money. Same-day is for genuine emergencies.' },
    ...
    educationSections: [
      {
        ...
        body: [
          'Same-day cleaning is $99/hr compared to $59–$79/hr for scheduled service. The premium covers the operational reality of last-minute scheduling.',
    ...
    pricingNote: 'Same-day cleaning is $99/hr flat. A focused 2-hour clean is $200. A thorough 3–4 hour apartment clean is $300–$400. For non-urgent needs, scheduling 2+ days ahead at $59–$79/hr saves 35–50%.',
    faqs: [
      ...
      { question: 'How do I book same-day service?', answer: 'Text or call (212) 202-9030 as early in the day as possible. Text is fastest — we\'ll confirm availability and estimated arrival time within minutes. Morning requests before 10am have the best availability for afternoon service.' },
    ],
  },
  ...
  'airbnb-cleaning': {
    ...
    educationSections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Our turnover service costs $59–$79/hr — a 1-bedroom turnover at 1.5–2 hours runs $89–$158. A 2-bedroom takes 2–2.5 hours at $118–$198.',
    ...
    pricingNote: 'Airbnb turnover cleaning costs $89–$237 per session. A studio turnover takes 1.5 hours ($89–$118). A 1-bedroom takes 1.5–2 hours ($89–$158). A 2-bedroom takes 2–3 hours ($118–$237). Most hosts pass this cost through as a guest cleaning fee.',
    faqs: [
      { question: 'How much does Airbnb turnover cleaning cost?', answer: 'Turnover cleaning is $59/hr with supplies on-site or $79/hr when we bring everything. A studio runs $89–$118 (1.5 hours). A 1-bedroom is $89–$158 (1.5–2 hours). A 2-bedroom is $118–$237 (2–3 hours). Most hosts set their Airbnb cleaning fee to match.' },
  ...
  'office-cleaning': {
    ...
    pricingNote: 'Office cleaning costs $59–$79/hr depending on supply arrangement. A small office (under 1,000 sqft) takes 2 hours ($98–$130/visit). A mid-size office (1,000–2,500 sqft) takes 3–4 hours ($147–$260). Larger spaces are quoted based on scope. Weekly clients get the most value.',
    faqs: [
      { question: 'How much does office cleaning cost in NYC?', answer: 'Office cleaning is $59/hr with your supplies or $79/hr when we bring everything. A small office (under 1,000 sqft) costs $98–$130 per visit. A mid-size office (1,000–2,500 sqft) runs $147–$260. Weekly service offers the best per-visit value.' },
      ...
      { question: 'Do you provide cleaning supplies for offices?', answer: 'At $79/hr we bring all cleaning products and equipment. At $59/hr you provide supplies. For office clients, we recommend keeping a supply closet with basic products, trash bags, and paper goods — we\'ll handle the rest.' },
    ],
  },
}
...
export function neighborhoodFAQs(neighborhood: Neighborhood, area: Area): { question: string; answer: string }[] {
  return [
    ...
    },
    {
      ...
      answer: `You can book online through our website, call us at (212) 202-9030, or text us. We typically can schedule within 24-48 hours, with same-day availability for urgent requests.`,
    },
    {
...
export function commonServiceFAQs(service: Service): { question: string; answer: string }[] {
  return [
    ...
    { question: 'How do I book a cleaning?', answer: 'Text or call (212) 202-9030. Tell us your address, preferred date, and any special requests. We\'ll confirm your appointment and match you with a cleaner, usually within the hour. You can also book online at cleaningservicesunnysideny.com.' },
    ...
    { question: 'Do you bring your own cleaning supplies?', answer: 'At $79/hr, yes — we bring professional-grade products, microfiber systems, and a commercial vacuum. At $59/hr, you provide your own supplies. Either way, we\'re happy to use specific products you prefer (eco-friendly, hypoallergenic, etc.).' },
    ...
    { question: 'Do you offer eco-friendly or green cleaning?', answer: 'Yes. If you prefer eco-friendly, plant-based, or hypoallergenic products, just let us know when booking. At $79/hr we can bring green products; at $59/hr you provide your preferred products and we\'ll use them.' },
    ...
    { question: 'Do you offer gift certificates?', answer: 'Yes — cleaning makes a great gift. Text us at (212) 202-9030 to purchase a gift certificate in any amount. We\'ll send a digital certificate that the recipient can redeem for any service.' },
