...
export default function DocsPage() {
  ...
  const sections = [
    ...
    { id: 'selenas', label: 'Selenas AI Chatbot' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex gap-8 p-6">
        <div className="w-52 shrink-0">
          <nav className="sticky top-6 space-y-0.5 max-h-[calc(100vh-4rem)] overflow-y-auto">
            {sections.map((sec) => (
              <button key={sec.id} onClick={() => setS(sec.id)} className={`block w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${s === sec.id ? 'bg-[#1E2A4A] text-white' : 'text-gray-600 hover:bg-gray-100'}`}>{sec.label}</button>
            ))}
          </nav>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <Card title="" accent="blue">
                <p><strong>Live:</strong> <a href="https://www.thenycmaid.com" className="underline">thenycmaid.com</a></p>
                <p><strong>GitHub:</strong> <a href="https://github.com/thenycmaid/nycmaid" className="underline">thenycmaid/nycmaid</a></p>
              </Card>
              <Card title="" accent="blue">
                <p><strong>Vercel:</strong> <a href="https://vercel.com/jeff-tuckers-projects/nycmaid" className="underline">jeff-tuckers-projects/nycmaid</a></p>
                <p><strong>Supabase:</strong> <a href="https://supabase.com/dashboard/project/ioppmvchszymwswtwsze" className="underline">ioppmvchszymwswtwsze</a></p>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <Badge color="gray">Selenas AI</Badge>
        ...
        {s === 'platform-map' && (
          <div>
            ...
            <T headers={['Service', 'Purpose', 'Used In']} rows={[
              ['Resend', 'Email delivery (hello@thenycmaid.com)', 'All emails — 21+ templates'],
        ...
        {s === 'stack' && (
          <div>
            ...
            <T headers={['Component', 'Technology', 'Version', 'Purpose']} rows={[
              ...
              ['SMS', 'Telnyx', '-', 'SMS delivery, inbound webhook, Selenas chatbot'],
...
└── lib/                            # 16 utility modules`}
        ...
        {s === 'lib' && (
          <div>
            ...
            <T headers={['File', 'Purpose', 'Key Exports']} rows={[
              ...
              ['sms-chatbot.ts', 'Selenas AI chatbot (state machine + agentic tool loop)', 'handleChatbotMessage'],
        ...
        {s === 'selenas' && (
          <div>
            <h1 className="text-3xl font-bold text-[#1E2A4A] mb-6">Selenas AI Chatbot</h1>
            <Card title="" accent="blue">
            ...
            <T headers={['Intent', 'Example Input', 'What Selenas Does']} rows={[
              ...
              ['Cancel', '"cancel my booking"', 'Explains 24-hour policy, asks for confirmation'],
            ...
            <T headers={['Topic', 'Key Info']} rows={[
              ...
              ['Supplies', '$49 = your own, $65 = full eco-friendly kit'],
        ...
        {s === 'sms' && (
          <div>
            ...
            <T headers={['Event', 'Action']} rows={[
              ...
              ['Inbound from existing client', 'Logs to client_sms_messages, routes to Selenas (existing client handler), sends response, notifies admin'],
        ...
        {s === 'bookings' && (
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li><strong>Hourly rates</strong> — $49/hr, $65/hr (Feb Discount), $75/hr</li>
        ...
        {s === 'portals' && (
          <div>
            ...
            <Card title="" accent="gray">
              ...
              <p><strong>Chatbot integration:</strong> When ?convo_id= is present (from Selenas chatbot), shows "Almost done!" banner, creates pending booking from chatbot data, migrates transcript to client</p>
        ...
        {s === 'emails' && (
          <div>
            ...
            <Card title="" accent="gray">
              <p><strong>Email Provider:</strong> Resend (from: hello@thenycmaid.com)</p>
        ...
        {s === 'settings' && (
          <div>
            ...
            <T headers={['Tab', 'Contents']} rows={[
              ...
              ['Referrals & Policies', 'Commission rate (10%), attribution window (48hr), active client threshold (45d), at-risk (90d), reschedule notice (7d recurring, 24h one-time)'],
        ...
        {s === 'troubleshooting' && (
          <div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <Card title="Selenas Chatbot Not Responding" accent="red">
