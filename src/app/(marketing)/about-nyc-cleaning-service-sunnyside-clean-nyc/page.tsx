...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, howToBookSchema, breadcrumbSchema, reviewSchemas, faqSchema } from '@/lib/seo/schema'
...
const description = 'Sunnyside Clean NYC is one of NYC\'s most trusted cleaning services — affordable rates from $59/hr, reliable background-checked cleaners, and consistent quality since 2018. A NYC Maid Services Company. Serving 267+ neighborhoods. 5.0★ Google. (212) 202-9030'
  ...
  return (
    <>
      <JsonLd data={[
        organizationSchema(),
        webSiteSchema(),
        webPageSchema({ url, name: title, description, type: 'AboutPage', breadcrumb: [{ name: 'Home', url: 'https://www.cleaningservicesunnysideny.com' }, { name: 'About', url }] }),
        localBusinessSchema(),
        howToBookSchema(),
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs items={[{ name: 'About', href: '/about-nyc-cleaning-service-sunnyside-clean-nyc' }]} />
      </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Truly Affordable', detail: 'Our rates start at $59/hr — well below the NYC average for licensed, insured cleaning. No surge pricing, no hidden fees, no travel charges. Same rate across Manhattan, Brooklyn & Queens.' },
      ...
      <section className="py-16 bg-gradient-to-b from-[#1E2A4A] to-[#243352]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-white tracking-wide text-center mb-4">The Sunnyside Clean Difference</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#1E2A4A] tracking-wide text-center mb-12">About Sunnyside Clean NYC</p>
