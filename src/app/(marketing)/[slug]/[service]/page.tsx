...
import { neighborhoodServicePageSchemas } from '@/lib/seo/schema'
...
export default async function NeighborhoodServicePage({ params }: Props) {
  ...
  return (
    <>
      <JsonLd data={neighborhoodServicePageSchemas(neighborhood, service, area)} />
