...
import { organizationSchema, webSiteSchema, webPageSchema, localBusinessSchema, howToBookSchema, breadcrumbSchema, faqSchema, areaItemListSchema, reviewSchemas } from '@/lib/seo/schema'
...
const areaFAQs = [
  ...
  { question: 'Do you charge extra for certain neighborhoods?', answer: 'No. Our rates are the same regardless of neighborhood or borough — $59/hr with your supplies, $75/hr when we bring everything. No travel fees, no surge pricing.' },
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed mb-10">
            Professional house cleaning from $59/hr in every neighborhood we serve. Same rates, same quality, same background-checked cleaners — whether you&apos;re in Manhattan, Brooklyn, or Queens.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          return (
            <section key={area.slug} id={area.slug} className="mb-16 scroll-mt-8">
              <div className="flex items-end justify-between mb-2">
                <Link href={`/service-areas/${area.urlSlug}`} className="group">
                ...
                <Link href={`/service-areas/${area.urlSlug}`} className="text-[#1E2A4A] text-sm font-medium hover:underline underline-offset-2 hidden md:inline">
                  View {area.name} &rarr;
                </Link>
              </div>
        ...
        <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] rounded-2xl p-8 md:p-14 mb-20">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl text-white tracking-wide mb-8">All Services — Same Rate Everywhere</p>
