            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/[0.06] backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
                ...
                <ul className="space-y-2.5 text-left">
                  ...
                  <li className="flex items-start gap-2.5"><span className="text-[#A8F0DC] mt-0.5 flex-shrink-0">&#10003;</span><span className="text-[#A8F0DC] text-sm font-semibold">10% off weekly &middot; 5% off biweekly/monthly</span></li>
                </ul>
              </div>
              ...
              <div className="bg-[#A8F0DC] rounded-2xl p-7 text-center relative">
                ...
                <ul className="space-y-2.5 text-left">
                  ...
                  <li className="flex items-start gap-2.5"><span className="text-[#1E2A4A] mt-0.5 flex-shrink-0">&#10003;</span><span className="text-[#1E2A4A]/80 text-sm font-semibold">20% off weekly &middot; 10% off biweekly/monthly</span></li>
                </ul>
              </div>
